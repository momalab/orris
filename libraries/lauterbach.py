...
class Lauterbach:
    def __init__(self, multipleInstances=False, T32_PORT = ''):
        self.T32_PATH = ''
        ...
        self.Initialize(multipleInstances)
        
    ### General Helper Modules ###

    def Initialize(self, multipleInstances):
        configReader = configparser.ConfigParser()
        configReader.read_file(open(r'libraries/lauterbach-config'))
